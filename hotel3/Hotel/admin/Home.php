    ...
    ?>
        ...
        ?>
                                <div class="panel panel-info">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                        <button type="button" class="btn btn-primary" data-toggle="modal" id="del" data-target="#form_modaldel"><span class="glyphicon glyphicon-plus"></span> Delete </button>
            ...
            ?>
            <div class="modal fade" id="form_modaldel" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<form action="Del_queryAdmin.php" method="GET" enctype="multipart/form-data">
				<div class="modal-content">
					...
					<div class="modal-footer">
						...
						<button name="del" class="btn btn-primary"><span class="glyphicon glyphicon-save"></span> Delete</button>
					</div>
				</div>
			</form>
		</div>
