    ...
    <div id="login">
      <form method="post">
        <fieldset class="clearfix">
          ...
          <li><a href="./absen/index.php"><i class="fa fa-sign-out fa-fw"></i> Pegawai</a>
        </fieldset>
      </form>
    </div> <!-- end login -->
  </div>
  <div class="bottom">  <h3><a href="../IndexHome.php">GUEST HOUSE USER LOGIN</a></h3></div>  
</body>
</html>
<?php
include('Db.php');
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $sql = "SELECT id FROM loginuser WHERE usname = '$myusername' and pass = '$mypassword'";
