...
<?php 
	if (isset($_GET['st'])) {
      ...
      echo "<div class='alert alert-danger'><strong>NP sudah terdaftar!</strong></div>";
    }
	}
...
<form class="form-horizontal" role="form" style="width:80%" onSubmit="return validasi()" name="formulir" method="post" action="./model/proses.php">
  <div class="form-group">
    <label class="control-label col-sm-2" for="name">NP:</label>
    <div class="col-sm-10">
      <input type="number" class="form-control" name="nis" placeholder="Masukan NP" required>
    </div>
  </div>
