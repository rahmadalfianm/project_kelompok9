                ...
                <div class="row">
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-footer">
							...
							<input type="submit" name="conform" value="Conform" class="btn btn-success">
					...
					<?php
						...
						while($rrow=mysqli_fetch_array($rre))
						{
							...
							if($s=="Suite Family Room" )
							{
								$sr = $sr + 1;
							}
							if($s=="Suite Double Room" )
							{
								$dr = $dr + 1;
							}
						...
						while($crow=mysqli_fetch_array($cre))
						{
							...
							if($cs=="Suite Family Room" )
							{
								$csr = $csr + 1;
							}
							if($cs=="Suite Double Room" )
							{
								$cdr = $cdr + 1;
							}
